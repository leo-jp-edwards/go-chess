...
func createPiece(sign string, row, col int) Piece {
	...
	return Piece{sign, colour, row, col}
}
...
func getMoves(board Board, piece Piece) []string {
	...
	case WhiteKing, BlackKing:
		return getKingMoves(row, col, board, colour)

	case WhiteQueen, BlackQueen:
		return getQueenMoves(row, col, board, colour)

	case WhiteRook, BlackRook:
		return getRookMoves(row, col, board, colour)

	case WhiteBishop, BlackBishop:
		return getBishopMovesAt(row, col, board, colour)

	case WhiteKnight, BlackKnight:
		return getKnightMoves(row, col, board, colour)

	case WhitePawn, BlackPawn:
		return getPawnMoves(row, col, board, colour)
...
func getKingMoves(row, col int, board Board, team Colour) []string {
...
func getQueenMoves(row, col int, board Board, team Colour) []string {
	var moves []string
...
func getRookMoves(row, col int, board Board, team Colour) []string {
	var moves []string
...
func getBishopMovesAt(row, col int, board Board, team Colour) []string {
...
func getKnightMoves(row, col int, board Board, team Colour) []string {
	var moves []string
...
func getPawnMoves(row, col int, board Board, team Colour) []string {
